...
export default {
  ...
  argTypes: {
    ...
    value: {
      control: 'array',
      description: 'The current selected values in the dropdown (array for multiple select)',
    },
    onChange: {
      action: 'changed',
...
const Template: Story<SelectWrapperProps> = (args) => {
  const [selectedValue, setSelectedValue] = useState<string | string[] | number | number[]>(args.value);
