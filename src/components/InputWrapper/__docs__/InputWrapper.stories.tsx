...
WithPlaceholder.args = {
  ...
  required: false,
  info: '',
  placeholder: 'Enter your username',  // This will show the placeholder inside the input
...
WithError.args = {
  ...
  helperText: 'Please enter a username',  // Error message
  children: <TextField variant="outlined" fullWidth placeholder="Enter username" />,
};
...
WithSelectComponent.args = {
  ...
  error: false,
  helperText: '',
  placeholder: 'Please select a country', // Add placeholder text
  children: (
    <Select
      label="Country"
      defaultValue=""
